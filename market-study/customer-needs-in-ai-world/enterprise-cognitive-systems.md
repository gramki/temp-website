...
2. [What Has Always Existed — and Why That Is Not Enough Anymore](#2-what-has-always-existed--and-why-that-is-not-enough-anymore)
   - [Decision Services Are Not New](#21-decision-services-are-not-new)
   - [What Is Changing](#22-what-is-changing)
3. [Cognition as Enterprise Infrastructure](#3-cognition-as-enterprise-infrastructure)
   - [What “Cognition” Means in Enterprise Terms](#31-what-cognition-means-in-enterprise-terms)
   - [The Infrastructure Shift](#32-the-infrastructure-shift)
4. [Memory: Clarifying the Enterprise Meaning](#4-memory-clarifying-the-enterprise-meaning)
   - [Distinguishing Agent Memory vs Enterprise Memory](#41-distinguishing-agent-memory-vs-enterprise-memory)
   - [Enterprise Memory Requirements for Cognitive Systems](#42-enterprise-memory-requirements-for-cognitive-systems)
   - [Why This Is Becoming Infrastructure](#43-why-this-is-becoming-infrastructure)
5. [Accountability: What Is Actually New (and What Is Not)](#5-accountability-what-is-actually-new-and-what-is-not)
   - [What Has Always Been True](#51-what-has-always-been-true)
   - [Why Accountability Is Being Re-Institutionalized](#52-why-accountability-is-being-re-institutionalized)
   - [Accountability for Judgement — Reframed Precisely](#53-accountability-for-judgement--reframed-precisely)
6. [Regulatory and Standards Landscape](#6-regulatory-and-standards-landscape)
   - [Key Regulations](#61-key-regulations)
   - [Key Standards and Frameworks](#62-key-standards-and-frameworks)
7. [Enforcement Timelines vs Adoption Timelines](#7-enforcement-timelines-vs-adoption-timelines)
   - [Regulatory Enforcement (Indicative)](#71-regulatory-enforcement-indicative)
   - [Realistic Enterprise Adoption](#72-realistic-enterprise-adoption)
8. [Break-Neck Build vs Adoption Slow-Down: What Will Actually Happen](#8-break-neck-build-vs-adoption-slow-down-what-will-actually-happen)
9. [Segment-Specific Progression](#9-segment-specific-progression)
   - [Global, Heavily Regulated Enterprises (e.g., GSIBs)](#91-global-heavily-regulated-enterprises-eg-gsibs)
   - [Large Regional Enterprises](#92-large-regional-enterprises)
   - [Smaller / Community Enterprises](#93-smaller--community-enterprises)
   - [Non-Regulated Enterprises](#94-non-regulated-enterprises)
10. [Implications for Vendors and Enterprise IT](#10-implications-for-vendors-and-enterprise-it)
11. [Key Takeaways](#11-key-takeaways)
12. [Annotated Workflow Example: Collections & Recovery](#12-annotated-workflow-example-collections--recovery)
    - [Workflow Overview (Collections)](#121-workflow-overview-collections)
    - [Deterministic vs Discretionary Zones](#122-deterministic-vs-discretionary-zones)
    - [What Changes with Cognitive / Agentic Systems](#123-what-changes-with-cognitive--agentic-systems)
    - [Governance Artifacts: Then vs Now](#124-governance-artifacts-then-vs-now)
    - [Audit Interpretation Shift (Subtle but Real)](#125-audit-interpretation-shift-subtle-but-real)
13. [Minimum Viable Governance Stack for Cognitive Systems](#13-minimum-viable-governance-stack-for-cognitive-systems)
    - [Design Principle](#131-design-principle)
    - [Core Stack Layers (Minimum Viable)](#132-core-stack-layers-minimum-viable)
    - [What Can Be Deferred (Intentionally)](#133-what-can-be-deferred-intentionally)
    - [Why This Stack Is Sufficient Initially](#134-why-this-stack-is-sufficient-initially)
12A. [Annotated Workflow Example: Fraud Case Management](#12a-annotated-workflow-example-fraud-case-management)
    - [Workflow Overview (Fraud Case Management)](#12a1-workflow-overview-fraud-case-management)
    - [Deterministic vs Discretionary Zones](#12a2-deterministic-vs-discretionary-zones)
    - [Impact of Cognitive / Agentic Systems](#12a3-impact-of-cognitive--agentic-systems)
    - [Governance Artifacts: Then vs Now](#12a4-governance-artifacts-then-vs-now)
    - [Audit & Compliance Interpretation](#12a5-audit--compliance-interpretation)
12B. [Annotated Workflow Example: Credit Limit Management](#12b-annotated-workflow-example-credit-limit-management)
    - [Workflow Overview (Credit Limits)](#12b1-workflow-overview-credit-limits)
    - [Deterministic vs Discretionary Zones](#12b2-deterministic-vs-discretionary-zones)
    - [Impact of Cognitive / Agentic Systems](#12b3-impact-of-cognitive--agentic-systems)
    - [Governance Artifacts: Then vs Now](#12b4-governance-artifacts-then-vs-now)
    - [Audit Interpretation Shift](#12b5-audit-interpretation-shift)
14. [Closing Synthesis](#14-closing-synthesis)
