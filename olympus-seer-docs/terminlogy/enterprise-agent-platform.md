...
- **[Raw, Trained, Employed: A Terminology Framework for Enterprise Agents](./raw-trained-employed.md)** — Zeta's three-layer model for agent lifecycle and governance
- **[Agent-Oriented System (AOS): Definition, Structure, and Design Process](./agent-oriented-system.md)** — AOSM meta-model foundations
