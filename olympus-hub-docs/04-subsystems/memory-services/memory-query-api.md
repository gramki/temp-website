# Memory Query API Specification

> **Status**: 🟡 Draft  
> **Last Updated**: 2026-01-07  
> **Related**: [Memory Services README](./README.md) | [CAF Store REST API](../cognitive-audit-fabric/episodic-memory-store/caf-store-rest-api.md) | [Memory Access Tools](./memory-access-tools.md)
...
- [Memory Access Tools](./memory-access-tools.md) — Tool specifications
