# Enterprise Memory Access Tools

> **Status**: 🟡 Draft  
> **Last Updated**: 2026-01-07  
> **Parent**: [Enterprise Memory](./README.md)  
> **Related**: [Memory Services](../README.md) | [Query API](./query-api.md)
...
│   │                                                                        │    │
│   │   Executes query against OpenSearch (see query-api.md)                │    │
│   └───────────────────────────────────────────────────────────────────────┘    │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
- [Query API](./query-api.md) — Query API specification
