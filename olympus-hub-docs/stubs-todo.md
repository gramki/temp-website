...
| [automation-product-desk.md](./06-ux-architecture/tenant-domain/automation-product-desk.md) | APO workspace for charters and outcomes | 🔴 Stub | High |
| [scenario-design-desk.md](./06-ux-architecture/tenant-domain/scenario-design-desk.md) | PA workspace for normative design | 🔴 Stub | High |
| [automation-development-desk.md](./06-ux-architecture/tenant-domain/automation-development-desk.md) | Developer workspace for implementation | 🔴 Stub | High |
