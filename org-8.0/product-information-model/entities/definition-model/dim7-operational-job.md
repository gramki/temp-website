...
**Discovery process:** Operational Jobs are identified through operational experience, field research with Operational Personas, and analysis of Run Track work patterns. They are formally documented in Dim 7 through Modeling Tasks.
...
| Pursued by | List of References (Dim 7) | Which Operational Persona(s) pursue this job |
| Enabled by | List of References (Dim 8) | Which Value Stream(s) or Capability(ies) enable this job |
| Measured against | List of References (Dim 7) | Which Operational Target(s) define success for this job |
...
|---|---|---|
| Pursued by | Operational Persona (Dim 7) | Operational Personas pursue this job |
| Accomplished through | Operational Journey (Dim 7) | Operational Jobs are accomplished through journeys |
| Enabled by | Value Stream / Capability (Dim 8) | Structural entities that deliver this operational capability |
| Measured against | Operational Target (Dim 7) | Operational Targets define success criteria for this job |
| Instantiated by | Run Track work entities (Track 3) | Deployment, Incident, Change Request, Maintenance Task are instances |
| Work Model | Modeling Task (Track 1) | Operational Jobs are documented through Modeling Tasks |
