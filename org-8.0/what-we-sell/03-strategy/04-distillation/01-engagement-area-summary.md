...
|-----------------------------|----------------------------|-------------------------------------------------------------------|
| [Cloud and Platform Ops](../02-engagement-areas/10-cloud-and-platform-operations.md) | [Cloud Fabric](../03-product-lines/01-infra-fabrics/03-cloud-fabric.md) | Deployment infrastructure for all Zeta products |
| [Digital Identity and Trust](../02-engagement-areas/08-digital-identity-and-trust.md) | [Trust Fabric](../03-product-lines/01-infra-fabrics/01-trust-fabric.md) | KYC/authentication layer – serves Payments, Account Products, Compliance         |
| [Customer Lifecycle](../02-engagement-areas/05-customer-lifecycle-and-engagement.md) | [Quark](../03-product-lines/04-product-lines/05-quark.md) CLM + [Evolution Fabric](../03-product-lines/01-infra-fabrics/04-evolution-fabric.md) | Spans onboarding, servicing, cross-sell across product areas      |
