...
**The challenge every bank recognizes. An alternative no one has tried — because it was never possible.**

---

## Reading Order

The documents below form a deliberate sequence — each builds on the last, moving from felt problems through structural analysis to a governing thesis and its implications.

1. **[Chapter 01: Why Every Step Forward Gets Harder](01-problems.md)** — The felt problems that mid-size and large banks live with, the procurement patterns that cause them, the real cost of integration, and the compound dynamics that make these problems self-reinforcing and worsening.

2. **[Chapter 02: The Systems Gap](02-gap.md)** — A detailed enumeration of twelve system types required by a modern enterprise, their roles, and their current maturity in banks. The core finding: banks are strong in Record and Enforcement, but weak or fragmented in everything else.
...
7. **[Chapter 07: The Hub Way](07-the-hub-way/README.md)** — The operationalization of the thesis: a framework for modeling work in enterprise banking domains.
