# The Enterprise AI Problem — Why Project-by-Project Won't Get There

The [preceding analysis](beyond-systems.md) establishes that closing the systems gap through capability acquisition alone is necessary but not sufficient — the bank needs both the capabilities and a model of the work that gives them context, coherence, and composability. AI is the capability that proves this argument most urgently. It is not just another system to integrate. It is the first technology wave that changes *who resolves the work itself* — and it cannot deliver enterprise value without the structural model that the systems-first approach never produces.
...
*Previous: [Beyond Systems](beyond-systems.md) · [Reading Order](README.md) · Next: [The Thesis](thesis.md)*