# Account Products and Core Banking — Opportunity Analysis
...
**Zeta's position is conditional.** Zeta has a conceptually differentiated offering: the Evolution Fabric + Tachyon combination (operational model + account platform) is a positioning no competitor occupies. But every Tachyon product line description is a placeholder brief. There are no public production deployments, no named customers, and no analyst coverage. Every competitor has named production references — Thought Machine has Lloyds and Standard Chartered, Mambu has BancoEstado and 200+ clients, 10x has Chase UK. Until Tachyon's production readiness is established, the Right to Win assessment for this engagement area is uncertain.

**Recommended actions:** (1) Resolve the Tachyon readiness question immediately — this gates every subsequent decision. (2) Secure 1–2 Indian bank pilots for Tachyon DDA to build the first production reference in Zeta's home market. (3) Engage Celent and Datos Insights for analyst coverage — without it, Zeta is invisible to mid-market buyers. (4) Defer US market entry, business banking, and BaaS until Tachyon has production evidence and India references. The opportunity is real and the market timing is favorable — but Zeta's ability to capture it depends on a product readiness question that this analysis cannot answer from the outside.
...
Zeta's account products assets (Tachyon product lines) and operational infrastructure (Evolution Fabric, Quark domain hubs) map to the structural shifts identified in Part I — but with a critical qualification that must be stated before any mapping exercise.

**The Tachyon documentation gap.** Every Tachyon product line description — Kernel, DDA, Credit Cards, CLM, Loans — reads "To be expanded." There are no public production deployments, no named customers, no technical readiness documentation. Every competitor cited in Part I has named production deployments: Thought Machine has Lloyds, Standard Chartered, Intesa Sanpaolo, and Judo Bank. Mambu has BancoEstado (14 million customers), Leeds Building Society, and 200+ clients. 10x Banking has Chase UK with 2.5 million customers and £15 billion in deposits. Pismo has Citigroup. What does Tachyon have? If Tachyon is production-ready but undocumented, the documentation gap must be closed immediately — it is a sales-disqualifying deficiency. If Tachyon is not production-ready, every assessment that follows is conditional.

| Structural Shift | Zeta Asset | Readiness |
|---|---|---|
| Progressive core replacement | Tachyon Kernel + DDA | **Uncertain** — no production deployment evidence. Cloud-native architecture is claimed but unvalidated against competitors with named Tier 1 references |
| Cloud-native core infrastructure | Tachyon (all product lines) | **Uncertain** — cloud-native by design intent, but no CB RADAR entries, no analyst coverage, no cloud deployment case studies |
| Composable banking architecture | Tachyon + Quark domain hubs | **Conceptually strong** — Quark's pre-modeled operational domains are a genuinely differentiated concept. No competitor ships pre-built domain hubs with operational models. But: also placeholder briefs, no named deployments |
...
| Deposit competition / product agility | Tachyon DDA | **Uncertain** — if Tachyon DDA enables rapid product configuration (goal-based savings, conditional interest, subscription banking), this addresses the deposit agility gap. No evidence either way |
...
|---|---|---|---|
| **Progressive core migration (Tier 2 US)** | **Strong.** $15–20B vendor-addressable TAM. 53% bank dissatisfaction with core providers. Mid-market gap is clear — no vendor delivers genuinely integrated, affordable, cloud-native account infrastructure for banks between $10B and $100B in assets | **Uncertain.** Conditioned entirely on Tachyon production readiness. Cloud-native challengers entered this market with <$100M revenue and now serve Tier 1 banks. Market is fragmented (top 3 hold only 30.1% deal share). But: Thought Machine, Mambu, and 10x each have 3+ years of production evidence. Tachyon has none | **Conditional — pursue ONLY if Tachyon has production-grade core banking capability.** If yes, target Tier 2 US banks ($10–100B assets) actively evaluating alternatives post-FIS-TSYS consolidation. If no, defer until product is ready |
| **Progressive core migration (India)** | **Strong.** SBI, HDFC Bank, and Axis Bank are all actively modernizing. India is Zeta's home market with existing bank relationships | **Medium-Strong.** Home market advantage, existing relationships, regulatory familiarity. Infosys Finacle (29.8% India share) and TCS BaNCS are the incumbents — but both have weaker cloud-native narratives than a purpose-built challenger | **Pursue.** Lead with Tachyon DDA in India. Build the first production reference before attempting US entry. India success is a prerequisite for global credibility |
...
| **BaaS enablement (Tier 2)** | **Strong.** Post-Synapse market restructuring ($21B→$106B by 2035). FDIC proposed Synapse Rule demands real-time customer-level deposit visibility. Legacy cores structurally inadequate for multi-tenant, partner-mediated deposits | **Medium.** If Tachyon is production-ready, cloud-native multi-tenant architecture is a genuine advantage. Westpac launched BaaS on 10x in 18 months — the model is proven. But: requires core banking credibility first | **Build toward.** Develop BaaS packaging after establishing core banking references. BaaS is an expansion play, not an entry play — banks will not trust their partner deposits to an unproven core |
| **AI in account operations** | **Strong.** CIBC CRTeX, Wells Fargo AI agents via Google Agentspace. Synthetic identity fraud at $3.3B H1 2025 exposure. Banks need governed AI in account lifecycle | **Strong.** Evolution Fabric + Seer is the structural differentiator. No competitor combines account infrastructure with an explicit operational model and AI agent governance. This is unique | **Pursue as long-term differentiator.** This is the expansion sale after establishing the platform relationship — not the entry sale. A bank must first trust Tachyon as its account platform before it will adopt Evolution Fabric as its operational model |

### What to defer or avoid

Do not pursue **Tier 1 US banks** as the primary entry segment. JPMorgan selected Thought Machine. Wells Fargo built Vantage internally. Citi is recruiting a Head of Core Banking Transformation. These banks build strategically, require 18–36 month sales cycles, and will not adopt from an unproven vendor.
...
1. **Tachyon must be production-ready for core banking workloads.** Not "in development," not "architecturally capable" — production-ready with the ability to process deposits, manage account lifecycle, handle regulatory reporting, and survive a Tier 2 bank's due diligence. Without this, no subsequent recommendation is actionable.
2. **Zeta must acquire 1–2 production references within 18 months.** India is the most feasible market. A mid-market Indian bank running Tachyon DDA in production transforms every Right to Win assessment from "uncertain" to "credible." Without a reference, Tachyon is a thesis, not a product.
...
- **No production deployments.** This is the most significant gap. Every other assessment is conditional on closing it.
- **All Tachyon product lines are placeholder briefs.** Whether this reflects a documentation gap or a product maturity gap, it must be resolved. Either outcome requires immediate action.
...
|---|---|---|
| **Resolve the Tachyon readiness question** | Every recommendation in this analysis is conditional on Tachyon's production maturity. If Tachyon is production-ready, document it — reference deployments, technical capabilities, performance benchmarks. If it is not, establish a timeline and gate all market entry on that timeline | **Immediate** |
| **Secure 1–2 Indian bank pilots for Tachyon DDA** | India is the home market with existing relationships. A mid-market Indian bank running Tachyon DDA in production transforms the Right to Win from "uncertain" to "credible." SBI, HDFC, and Axis are all modernizing — but start with a smaller institution where deployment risk is manageable | **Immediate** |
...
| Action | Rationale | Priority |
|---|---|---|
| **Enter US Tier 2 core banking market** once India references are established | The mid-market gap ($10–100B banks) is real. FIS-TSYS integration creates a window. But: arrive with production evidence, analyst coverage, and demonstrable pricing advantage | **2028** |
...
| Dimension | Account Products & Core Banking | Payments | Digital Identity & Trust | Cloud & Platform Ops | Agentic Banking | Agentic Operations |
|---|---|---|---|---|---|---|
| Market structure | Oligopoly (FIS, Fiserv, Jack Henry) + fragmented cloud-native challengers | Oligopoly (FIS, Fiserv, GP) + fragmented challengers | Fragmented IAM vendors | Hyperscalers + observability tools | Nascent; no dominant vendor | Emerging; workflow + AI vendors |
| Competitive intensity | Very high — incumbents hold 15–25 year relationships with deep switching costs | Very high | Medium | High (hyperscaler adjacency) | Low (new category) | Medium |
| Regulatory forcing | Moderate — only 5 of 19 regulations force core replacement; most are wrappable | Very strong (multiple concurrent mandates) | Strong (GDPR, PSD2/3, DPDP) | Medium | Weak | Medium (audit/compliance) |
| Geographic concentration | UK leads active transformation pipeline (10 institutions); US is primary vendor TAM | USA 30–40% of global spend | Distributed | Distributed | USA-first | Distributed |
...
| Vendor-addressable TAM | $15–20B (Tier 2–3 vendor-addressable); $25–40B (broad composite) | $60–85B (narrow); $150–200B (broad) | $15–25B (IAM/IGA) | $10–15B | <$5B (nascent) | $5–10B |
