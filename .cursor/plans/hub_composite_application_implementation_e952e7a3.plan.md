...
# Hub Composite Application Documentation Plan

## Overview

Document **Hub Composite Applications** design enabling multiple Hub Applications to participate in the same Request. Composites are resolved at **deployment time** - Signal Exchange sees only a list of apps per scenario, not composites.

**Scope:** Design documentation only. Code implementation is out of scope for this plan.
