...
A family member doesn't wake up thinking "I need to execute Journey 1.1 - Monthly Household Bills". They think:
...
- 10 journey types × 6 scenarios each = 60 features
...
- Moments ("paycheck deposited, now what?")
- Conversations ("honey, did you pay the electricity?")
- Decisions ("should we prepay the mortgage or invest?")
...
| Constraint | Impact on Family Banking |
|------------|-------------------------|
| **Screen real estate** | Can show 4-5 menu items max. 10 journey types means deep nesting and feature burial. |
| **Attention span** | Mobile sessions are 2-3 minutes. Complex navigation = abandonment. |
...
**US banking app data (R3.1):**
- 80-85% of customers use mobile banking apps
- Average 8-12 logins per month
- **Only 20% of features are used**
- Complex feature usage: <10%
- App abandonment rate: 30-40%
...
No single app has succeeded at "comprehensive family finance." Banks that try to be everything end up with feature bloat and low adoption.

### The App Fatigue Problem

US families already have:
- Bank app (sometimes multiple)
- Payment apps (Venmo, Zelle, Cash App)
- Investment app (Robinhood, Fidelity, Schwab)
- Insurance app
- Tax filing app (TurboTax, H&R Block)
...
| Open app → Go to Goals → Create New Goal → Family Vacation | "Help us save $5,000 for vacation in 6 months" |
| Check 3 different screens to understand family finances | "How are we doing financially?" |
| Learn complex workflow for expense splitting | AI automatically tracks who paid what, suggests settlements via Venmo/Zelle |
...
| **SMS/Email** | Family expense coordination, bill reminders, proactive alerts |
| **Notifications** | Proactive alerts ("3 bills pending this week") |
| **Voice assistants** | Quick queries ("Alexa, did we pay the electricity?") |
| **AI assistants** | Comprehensive conversations about family finances (ChatGPT, Gemini, Siri) |
...
| "Create Shared Goal" → Set amount → Add contributors → Track | Agent: "You're both saving for vacation. Combined: $3,200 of $5,000." |
...
| **SMS/Email** | Text-based communication | AI assistants within messaging, payment integration | Family finance coordination via SMS/email |

**US Adoption (R1.3):**
- 50-60% of US adults use voice assistants
- 35-40% of households have smart speakers
- ~100M ChatGPT monthly active users in US
- 15-25% have used voice assistants for financial tasks
...
- Proactive notifications (SMS, email) for time-sensitive insights

**Secondary Channels (Embedded):**
- Bank mobile app with family features (for users who prefer visual interface)
- SMS/Email for family coordination
- Email for summaries and reports

**US Channel Preferences (R3.3):**
- Mobile app: 80-85% for transactions
- SMS: 70-75% for notifications
- Email: 90-95% for documentation
- Voice: 20-30% for quick queries
- Chat: 40-50% for support
- **85% expect multi-channel support**
...
| **Voice** | "Hey Siri, can we afford a $1,500 fridge right now?" |
| **Visual** | Family dashboard in bank app, charts and graphs |
| **Proactive** | SMS: "Electricity bill due tomorrow. Pay now?" |
...
The 60+ family financial scenarios we identified don't become 60 app screens. They become **agent capabilities**—things the agent can understand, reason about, and help with.
...
| **1.4 Splitting Expenses** | Expense splitting workflow: add expense → split → notify | Agent automatically tracks family expenses, calculates who owes what, suggests settlements via Venmo/Zelle. No manual entry. |
| **2.2 Saving for Vacation** | Goals section → Create Goal → Track Progress | Agent: "You want to go to Hawaii in 6 months? Let me help you save $5,000. I'll set aside $850/month automatically." |
...
| **9.1 Unauthorized Transaction** | Navigate to Disputes → File Claim → Track | Agent: "I see a $500 transaction you didn't make. Want me to block the card and file a dispute immediately?" |
...
- Tracks family obligations (bills, loans, subscriptions)
...
**4. Action Execution**
- Executes payments on behalf of family (ACH, Zelle)
...
| **Integration layer** to connect with banks, payment rails (ACH, Zelle), investments | **Standalone app** competing with existing apps |
| **Channel adapters** for ChatGPT, Gemini, Siri, SMS, email, bank apps | **Proprietary chat interface** |
...
US families struggle with fragmented financial management:
...
US families have an intelligent financial partner:
...
>
> "Yes, Sarah paid $120 on the 5th. All household bills are current. Next up is the internet bill on the 15th."

> **"ChatGPT, can we afford to buy a new fridge?"**
>
> "A $1,500 fridge would impact your vacation savings goal. Options: (1) Delay vacation by 2 months, (2) Split fridge cost over 3 months using credit card, (3) Use emergency fund and replenish over 4 months. Which would you like to explore?"
...
**The insight:** 60+ family financial needs cannot be addressed through a traditional mobile app. The medium imposes constraints that make comprehensive solutions impractical.

**The approach:** Build intelligent agents with family banking capabilities that can be accessed through AI assistants (ChatGPT, Gemini, Siri, Alexa), embedded in existing apps, and delivered proactively through SMS, email, and notifications.
