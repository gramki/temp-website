...
8. [US Compliance and Security](#us-compliance-and-security)
...
We propose an AI-native approach to family banking: instead of building another mobile app, we deploy an **intelligent agent** that serves families across any channel—ChatGPT, Siri, Alexa, SMS, email, or our own app.
...
**Key differentiators:**
- **One relationship, many channels:** Same context whether on voice, chat, SMS, or app
...
- **US-compliant:** Built for FDIC, CFPB, state regulations, and security standards
...
- **Channel-locked:** Context lost when switching between app, voice, SMS, or email

### The AI-Native Opportunity

The next generation of user interfaces won't be apps—they'll be conversations. Users already ask ChatGPT financial questions. Siri and Alexa are becoming more capable. SMS and email are primary US communication channels.
...
- Gives advice: "Should we prepay the mortgage or invest more?"
- Protects: "I blocked a suspicious transaction on your spouse's card"
...
|-----------|---------------|
| "Pay the electricity bill" | "Done. Paid $120 to ConEd from your checking account." |
| "Should we invest or prepay mortgage?" | "Given your retirement goal, I'd suggest putting $2,000 toward your 401k and $1,000 toward mortgage prepayment. Here's why..." |
| "There's a wrong charge on my card" | "I see a $250 charge at XYZ Restaurant on Jan 10. That doesn't match your usual pattern. Want me to raise a dispute?" |
| "Are we ready for tax filing?" | "Almost. I have your W-2s and investment statements. Still need: Q4 property tax receipt and 3 medical bills." |
...
│      (ChatGPT, Gemini, Siri, Alexa, Bank App, SMS, Email)            │
└──────────────────────────────┬──────────────────────────────────────┘
                               │
                               ▼
┌─────────────────────────────────────────────────────────────────────┐
...
│  ┌──────────────┐ ┌──────────────┐ ┌──────────────┐                │
│  │ Core Banking │ │ Payment Rails│ │   Security   │                │
│  │   Systems    │ │ (ACH, Zelle) │ │  (PCI-DSS)   │                │
│  └──────────────┘ └──────────────┘ └──────────────┘                │
└─────────────────────────────────────────────────────────────────────┘
```
...
One orchestrator per channel: ChatGPT, Gemini, Siri, Alexa, Bank App, SMS, Email. Each orchestrator:
...
**US Channel Support (R3.3):**
- Mobile app: 80-85% preference for transactions
- SMS: 70-75% preference for notifications
- Email: 90-95% preference for documentation
- Voice: 20-30% preference for quick queries
- Chat: 40-50% preference for support
...
- Tracks documents for tax filing (W-2s, 1099s, receipts)
...
- Responds to planning questions ("How should I structure my mortgage payment?")
...
4. Payments Doer checks authorization, executes via ACH, confirms
5. Response: "Done. Paid $120 to ConEd from your checking account."
...
**User (via ChatGPT):** "We have $20,000 extra. Should we prepay our mortgage or put it in our daughter's 529 plan?"
...
2. Advisor consults Loans Thinker: "Prepaying saves $15,000 interest over tenure"
3. Advisor consults Investments Thinker: "529 plan needs $50,000 in 8 years. Current trajectory: $40,000. Gap: $10,000"
...
3. Protector notifies cardholder via preferred channel (SMS/email)
...
2. Steward inventories documents: W-2s ✓, Investment statements ✓, Q4 property tax receipt ✗, 3 medical bills ✗
3. Steward surfaces reminder: "Tax filing deadline in 3 weeks. Missing: Q4 property tax receipt, 3 medical bills."
...
**Situation:** Spouse A wants vacation savings. Spouse B wants mortgage prepayment.
...
2. Advisor analyzes: Vacation goal $5,000 by August. Mortgage $200,000 outstanding. Extra monthly capacity: $500.
3. Advisor proposes compromise: "$300 to vacation ($5,000 by July), $200 to mortgage (closes 4 months early, saves $2,000 interest)"
...
**Day 1, SMS:** "I want to apply for a personal loan"

1. SMS Orchestrator → Concierge → Loans Thinker
...
2. Concierge retrieves context: "Yesterday we discussed a personal loan. You're eligible for up to $50,000 at 8.5%. Ready to proceed?"
...
**Trigger:** Family has $30,000 idle in savings
...
2. Influencer suggests to Advisor: "Recommend 529 plan contribution"
...
Users will interact via ChatGPT, Gemini, Siri, Alexa, SMS, email—and channels not yet invented. Building channel-specific experiences is unsustainable. This architecture:
...
## US Compliance and Security

### Regulatory Compliance (R4.2, R4.3, R2.13)

**CFPB Requirements:**
- Fair lending: AI decisions must not discriminate
- Explainability: AI decisions must be understandable
- Transparency: Clear disclosures about AI usage
- Bias testing: Regular testing for protected class impacts

**FDIC Requirements:**
- Insurance coverage: Account structure considerations
- Safety and soundness: Risk management for AI systems

**State Regulations:**
- State banking departments: Multi-state compliance
- Privacy laws (CCPA, etc.): Data protection requirements

**Implementation:**
- Bias testing built into model training and deployment
- Explainability layer for all AI decisions
- Regular compliance audits
- Human oversight for high-risk decisions

### Security Standards (R4.4)
...
### Banking Integration (R4.1)

**Core Banking Systems:**
- Integration with Fiserv, FIS, Jack Henry systems
- REST APIs for modern systems
- SOAP APIs for legacy systems
- Real-time data access

**Payment Rails:**
- ACH integration for transfers
...
- Support for multiple core banking systems
...
**Capabilities:**
- Bill payments with context (ACH)
- Payment reminders
...
- Investments Domain agents (401k, IRAs, brokerage)
- Loans Domain agents (mortgage, auto, personal)
- Cards Domain agents

**Capabilities:**
- Cross-domain advice ("invest vs. prepay mortgage")
- Investment tracking
- Loan management
- Spend insights
...
**Add:**
- SMS/Email Orchestrators
- Voice Orchestrators (Siri, Alexa)
- Steward (documents, tax)

**Capabilities:**
- Conversational banking via SMS/email
- Voice interactions
- Tax document organization (W-2s, 1099s)
...
| **Compliance first** | Build compliance into architecture, not afterthought |
...
3. **Balances interests** through explicit separation of customer and bank objectives
4. **Ensures security** through architectural design
5. **Complies with US regulations** through built-in compliance controls

**The result:** A family banking platform that is intelligent, trustworthy, and compliant—ready for the AI-native future of banking.

---

> **Continue Reading:** [Customer Value →](./value-to-customers.md) — What families receive and why they'll adopt
>
