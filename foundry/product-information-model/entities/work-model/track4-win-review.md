...
1. **Feedback** (qualitative) — Observations recorded as Feedback artifacts. Feedback is a transitional artifact: it may be promoted to a Signal in Strategy if actionable, or archived if informational. May include observations about Customer Promise gaps.
...
| Customer / Segment | Reference (Customer Value) | Which customer or segment is being reviewed |
| Initiative(s) Assessed | List of References (Strategy) | Which Initiative(s) this review assesses progress against |
| Participants | List of References (Vendor Value) | Win Stakeholders participating in the review |
...
| Customer Promise(s) Assessed | List of References (Customer Value) | Which Customer Promises are assessed in this review (Value Propositions, Service Commitments, Compliance Posture) |
...
|---|---|---|
| Produces | Feedback (Win) | Win Review produces Feedback artifacts (qualitative observations) |
| Assesses | Initiative (Strategy) | Win Review assesses Initiative target progress and updates quantitative measures |
| Assesses | Win Activity (Win) | Win Review assesses the results of Win Activities |
| Assesses | Win Enablement (Win) | Campaign/Program Reviews assess enablement asset and program effectiveness |
| Assesses | Win Case (Win) | Case Pattern Reviews assess Win Case patterns |
| Assesses | FIR (Win) | Win Review assesses FIR volume, triage quality, routing patterns, and resolution quality (DR-032) |
| Assesses | Customer Promise (Customer Value) | Win Review assesses whether Customer Promises (Value Propositions, Service Commitments, Compliance Posture) are being fulfilled |
| References | Customer Value Metric (Customer Value) | Win Review references Customer Value Metrics as evidence of promise fulfillment |
| Consumes | Incident summaries (Run) | Win Reviews may consume summarized incident communication (from Customer Communication Task outputs) when assessing Customer Promise fulfillment — the Run Track owns incident communication, the Win Track consumes summarized/enhanced views |
| Participants are | Win Stakeholder (Vendor Value) | Win Stakeholders participate in reviews |
| Scoped to | Customer Segment (Customer Value) | Win Review is scoped to a customer or segment |
| Assesses | API Module (Ecosystem) | Win Review assesses API adoption, developer satisfaction, and SLO compliance |
| Assesses | API Compatibility Contract (Ecosystem) | Win Review assesses contract compliance |
