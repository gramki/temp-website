...
>
> **Envelope pattern.** FIR parallels Change Request (Track 3): Change Request is the governance envelope for deployment-related work; FIR is the intake envelope for all product-in-operation feedback. Both are parent entities whose lifecycle depends on the completion of their sub-items.
...
| Customer / Tenant | Reference (ESR / Dim 7) | Optional — which customer organization or tenant is affected. References ESR for customer identity, Deployment Environment (Dim 7) for tenant. |
...
| May produce | Signal — Problem / Need / Opportunity (Dim 1, PIR) | Feedback routed as discovery input |
...
| Assessed by | Win Review (Track 4) | FIR volume, triage quality, routing patterns, and resolution quality are assessed |
| Monitored by | Win Monitoring (Track 4) | FIR volume, resolution time, and routing patterns are continuously tracked |
| Feeds | Customer Value Metric (Dim 3) | FIR response and resolution times feed Service Level Metrics |
| References | Customer / Tenant (ESR / Dim 7) | Which external stakeholder and/or tenant is affected |
...
|---|---|---|---|
| Routed sub-items | Specification | Triage routing decisions that create work items in other tracks | Track 2 (Bug), Track 3 (Incident, Maintenance Task), Track 4 (Win Case), Dim 1 (Signal) |
...
|---|---|---|---|---|---|---|
| FIR-2026-04291 | Customer | Portal | Service Degradation | Critical | INC-2026-0847 (Track 3), WC-2026-1203 Complaint (Track 4) | In Progress |
| FIR-2026-04292 | Monitoring System | Monitoring Alert | Service Degradation | Critical | INC-2026-0848 (Track 3) | In Progress |
| FIR-2026-04293 | Customer | Email | Missing Capability | Medium | SIG-2026-0412 Need (Dim 1) | Triaged |
| FIR-2026-04294 | Customer | Chat | Question | Low | _(direct resolution — answered during triage)_ | Closed |
| FIR-2026-04295 | SRE | Internal Observation | Defect | High | BUG-2026-0891 (Track 2), INC-2026-0849 (Track 3) | In Progress |
| FIR-2026-04296 | QA | Internal Observation | Defect | Medium | BUG-2026-0892 (Track 2) | Resolved |
| FIR-2026-04297 | Partner | Portal | Request | Medium | WC-2026-1204 Service Request (Track 4) | In Progress |
...
- **Incident INC-2026-0847** (Track 3) — for SRE investigation and service restoration
