...
Articulates how the product's capabilities deliver the buyer's outcomes and relieve user pains. Maps Business Outcomes and Pains (Customer Value) to the product's structural delivery mechanism:

- **Outcome-based promises** → map to **Value Streams** (Structural) — because outcomes require end-to-end flows across modules.
- **Ability-based promises** → map to **Capabilities** (Structural) — because the promise is about a specific product ability.
...
|---|---|---|
| Customer Segment | Reference (Customer Value) | Which segment this proposition targets |
| Business Outcome(s) | List of References (Customer Value) | Which buyer outcomes this addresses |
| Pain(s) Relieved | List of References (Customer Value) | Which user pains this relieves |
| Promise Mapping Type | Enum | `Outcome-based` (maps to Value Stream) or `Ability-based` (maps to Capability) |
| Value Stream(s) | List of References (Structural) | For outcome-based: which Value Streams deliver the promise |
| Capability(ies) | List of References (Structural) | For ability-based: which Capabilities deliver the promise |
...
Guarantees reliability, performance, and support levels to the customer. The customer-facing commitment about how the product's infrastructure (Operational) will behave.
...
Certifies that the product meets regulatory, security, or industry standards. Compliance goes beyond operations — it is a core aspect of the product that influences many capabilities across Structural.
...
| Scope | List of References (Structural) | Which modules/capabilities are covered |
| Certification Date | Date | When last certified |
| Renewal Date | Date | When recertification is needed |
| Influences | List of References (Structural) | Which Capabilities are shaped by this compliance requirement |
...
| Customer Segment | Reference (Customer Value) | Which segment this promise applies to |
...
|---|---|---|
| Anchored to | Customer Segment (Customer Value) | Customer Promise is made to a Segment |
| Evidenced by | Customer Value Metric (Customer Value) | Customer Value Metrics measure/evidence this promise |
| Maps to (VP) | Value Stream (Structural) | Value Proposition (outcome-based) maps to Value Stream(s) |
| Maps to (VP) | Capability (Structural) | Value Proposition (ability-based) maps to Capability(ies) |
| Addresses (VP) | Business Outcome (Customer Value) | Value Proposition addresses Business Outcome(s) |
| Relieves (VP) | Pain (Customer Value) | Value Proposition relieves Pain(s) |
| Overlaps (SC) | Operational Dimension (Operational) | Service Commitment overlaps with Operational infrastructure |
| Influences (CP) | Capability (Structural) | Compliance Posture influences Capabilities |
| Work Model | Modeling Task (Discovery) | Modeling Tasks define/refine Customer Promises |
| Assessed by | Win Review (Win) | Win Reviews assess whether Customer Promises are being fulfilled |
| Tested by | Win Case (Win) | Win Case complaints test whether Service Commitments are being met |
...
| Justified by | PDR (Strategy) | Significant promise changes are justified by a PDR |
