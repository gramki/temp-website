...
| Realizes | List of References (Structural) | Which Value Stream(s) this flow realizes (technical counterpart) |
...
| External Dependencies | List of References (Technical) | Dependencies involved in this flow (e.g., external APIs, bank networks) |
...
|---|---|---|
| Realizes | Value Stream(s) (Structural) | Interaction Flow is the technical realization of a functional Value Stream |
| Involves | System(s) (Technical) | Systems participate in this flow |
| Uses | Dependency(ies) (Technical) | External dependencies involved in the flow |
| Decisions | ADR(s) (Technical) | Flow design decisions are recorded as ADRs |
| Context | Architecture Model (Technical) | Architecture Model's style determines available flow types |
| Related to | Operational Target(s) (Operational) | End-to-end latency/availability targets may apply to the entire flow |
| Realized by | Integration Epic (Build) | Integration Epics validate Interaction Flows end-to-end during build work |
