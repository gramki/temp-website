...
>
> The Definition Model captures down to **User Journey** (User Experience). Screen-level detail lives in:
...
>
> **Superseded by:** The User Journey entity captures the flow-level experience. The HI Module (Structural) carries the Capabilities and Features that produce specific UI interactions. Feature templates for HI Modules include experience attribute guidance that replaces the need for Definition Model touchpoint entities.
