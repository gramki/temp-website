...
| Stations | Ordered List of References (Operational) | The ordered sequence of Stations that compose this train |
...
|---|---|---|
| Contains | Station(s) (Operational) | The ordered sequence of checkpoints in this train |
| Scoped by | Change Request(s) (Run) | Change Requests are scoped to this train (or to a specific Station within it) |
| Referenced by | Customer Release Intent (Strategy) | A Customer Release Intent may span multiple Deployment Trains |
| Derived visibility | Tenant(s) (Run) | Tenants derive visibility into this train via their Deployment Environment |
| Justified by | ODR (Operational) | Operational decisions justify train design choices |
| Constrained by | Operational Constraint (Operational) | Constraints may mandate certain governance levels or station requirements |
