...
> Canonical analysis; mirrored at repo root for discoverability. Identical content lives in [`stories/deployment-artifacts-analysis.md`](stories/deployment-artifacts-analysis.md).
...
Operator-facing systems (probes, reconcilers, log shippers, cert automation) are **Systems in the Product Specification** with **Purpose / Serving Persona** pointing at Operational Personas. They are not a separate "package" layer.
...
For versioning rationale and why Module is excluded from the version stack, see [`stories/versioning-alternatives-analysis.md`](stories/versioning-alternatives-analysis.md). For end-to-end workflow, see [`change-to-deployment-analysis.md`](change-to-deployment-analysis.md).
