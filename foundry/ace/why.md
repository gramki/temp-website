...
ACE is not a platform vendor's playbook with a friendlier label. It is also not a research framework. It is the operating frame Zeta uses to engineer software with agents, and the document tree under [foundry/](../README.md) is the working specification.
