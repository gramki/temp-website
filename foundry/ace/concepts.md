...
- hosts multiple **Workshop Projects**.
...
> **Engagement extension.** For client delivery, an **Engagement is a Workshop** (e.g. a Bank-X Engagement is a Workshop named for that client). Each Product Zeta builds for that client corresponds to a **Workshop Project** inside that Workshop. **Home Workshop**, **Home Workshop Project**, **Engagement Workshop Project**, and **Contributing Workshop Project** are defined in [`../engagement-engineering/extension-to-ace.md`](../engagement-engineering/extension-to-ace.md).

## Workshop Project

A **Workshop Project** corresponds to a **Product** in UPIM: it is the venue — the locus — where that Product is evolved through workspaces and scenarios; it is **not** the Product itself. It contains multiple **Workspaces**, each owned by a distinct functional team.

A Workshop Project is the unit at which most operational metrics are captured: KPIs (Say/Do, Cost per Story Point, Velocity, Quality), agent efficiency and effectiveness, scenarios and tasks management, project-level reporting and analytics. Source: [`../foundry-platform/platform.TODO`](../foundry-platform/platform.TODO) lines 14-17.

> **Engagement Workshop.** Inside an Engagement Workshop, each Product under delivery is evolved in an **Engagement Workshop Project**. A **Contributing Workshop Project** is an Engagement Workshop Project that references a **Home Workshop Project** elsewhere; standalone engagement-specific Products exist only as Engagement Workshop Projects whose Home Workshop is the Engagement Workshop itself. Full treatment: [`../engagement-engineering/extension-to-ace.md`](../engagement-engineering/extension-to-ace.md).

## Workspace

A **Workspace** is a specialized station inside a Workshop Project, owned by a single functional team. Each Workspace:
...
Per-workspace detail is in [`workspaces/`](workspaces/).
...
For executive narrative — including the four-frame illustrations in [`illustrations/`](illustrations/) — repositories are clustered into four themes:
...
Product Intent items are owned. In the engagement view, the Engagement Workshop owns Product Intent items at the umbrella level — program-managed consolidation of intent for one or more Products (each evolved in its Workshop Project). Source: [`../1.TODO`](../1.TODO) line 11.
...
- **The engagement extension** (Engagement as Workshop, Workshop Project ↔ Product, Home Workshop Project, Contributing Workshop Project, Estate boundary). That is in [`../engagement-engineering/extension-to-ace.md`](../engagement-engineering/extension-to-ace.md).
