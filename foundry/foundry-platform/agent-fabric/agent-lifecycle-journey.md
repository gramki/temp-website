...
This document walks through the complete lifecycle of an agent in Foundry, from skill publication to task completion.

## Overview

```
Skill Published → Skilled Agent Defined → WO Assigned → Session Created →
Employed Agent Spawned → Task Executed → Completion Reported
```
...
- [skill-registry.md](skill-registry.md) — Skill packaging and distribution
- [capable-agents.md](capable-agents.md) — Capable Agent registry
- [employed-agents.md](employed-agents.md) — Employed Agent delegation model
- [gateway-policy.md](gateway-policy.md) — Gateway configuration
- [../work-order-runtime/agent-spawning.md](../work-order-runtime/agent-spawning.md) — Agent spawning details
- [../orchestrator/pi-journey.md](../orchestrator/pi-journey.md) — How agents fit in the PI flow
