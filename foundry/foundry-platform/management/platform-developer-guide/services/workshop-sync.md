...
The Workshop Sync Service processes changes from Foundry, Workshop, and User Work Catalog definition repositories and populates the Metadata Service with validated configuration.
...
|--------------|------------|
| `foundry.yaml` | Update Foundry config (Foundry repo) |
| `work-catalog/**` | Update Work Catalog (Foundry, Workshop, User repos) |
...
| `workbenches/{wb}/work-catalog/**` | Update Workbench Work Catalog |
