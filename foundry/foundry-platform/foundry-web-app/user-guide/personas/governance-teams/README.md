...
- Access to a Workbench with Governance Workspace membership
- Understanding of [ACE Governance concepts](../../../../ace/governance.md)
- Familiarity with control objectives and compliance registers
...
- [Governance Overview console](../../../platform-developer-guide/pages/consoles/governance/governance-overview.md) — Governance landing page
- [Registers Console](../../../platform-developer-guide/pages/consoles/governance/registers-console.md) — Risk, debt, exception registers
- [Controls & Enforcement console](../../../platform-developer-guide/pages/consoles/governance/controls-enforcement.md) — Control objective monitoring
- [Reports Console](../../../platform-developer-guide/pages/consoles/governance/reports-console.md) — Analytics and compliance reports
- [Governance Workspace console](../../../platform-developer-guide/pages/consoles/workspaces/workspace-governance.md) — Governance Workspace view
