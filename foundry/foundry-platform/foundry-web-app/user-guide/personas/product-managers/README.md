...
- Access to a Workbench with Product Specification Workspace membership
- Familiarity with [ACE Product Evolution Cycle](../../../../ace/README.md)
- Understanding of [Product Intent journey](../../../../orchestrator/user-guide/product-intent-journey.md)
...
- [Product Specification Workspace console](../../../platform-developer-guide/pages/consoles/workspaces/workspace-product-spec.md) — Page spec for the Product Specification Workspace
- [Orchestration Console](../../../platform-developer-guide/pages/consoles/work/orchestration-console.md) — Tracking Product Intents
- [Progress Console](../../../platform-developer-guide/pages/consoles/work/progress-console.md) — Release progress tracking
- [Product Intent journey](../../../../orchestrator/user-guide/product-intent-journey.md) — Full PI lifecycle walkthrough
