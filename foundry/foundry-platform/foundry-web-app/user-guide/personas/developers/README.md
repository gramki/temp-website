...
- Access to a Workbench with Development Workspace membership
- Foundry IDE installed and configured
- Familiarity with [Work Order lifecycle](../../../../work-order-runtime/user-guide/work-order-lifecycle.md)
...
- [Development Workspace console](../../../platform-developer-guide/pages/consoles/workspaces/workspace-development.md) — Page spec for the Development Workspace view
- [My Work console](../../../platform-developer-guide/pages/consoles/work/my-work.md) — Personal work queue
- [CI Console](../../../platform-developer-guide/pages/consoles/build/ci-console.md) — Build and test status
- [IDE Workspace Sessions](../../../../ide/user-guide/workspace-sessions.md) — IDE integration for developers
- [Product Intent journey](../../../../orchestrator/user-guide/product-intent-journey.md) — Understanding where Development fits
