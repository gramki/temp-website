...
| [tenant-developer-tooling/](tenant-developer-tooling/README.md) | Tooling for tenant developers (Olympus Workspace, Olympus Rocket, Hub Workbench). Moved here from the top level because it serves the engagement context. |
...
- **Workbench corresponds to a Product in UPIM** — each Product built for the client is evolved in an **Engagement Workbench** inside that Engagement Workshop; the Workbench is the locus of evolution, not the Product entity. **Home Workshop**, **Home Workbench**, **Contributing Workbench**, and standalone engagement-only Products are defined in [extension-to-ace.md](extension-to-ace.md). Source: [../1.TODO](../1.TODO) lines 4, 7-8 (historical phrasing); [../ace/relationships.md](../ace/relationships.md).
- **Operational shape.** A Workbench remains a collection of git repos, Jira boards, CI jobs, release artifacts, deployment trains, and people, adhering to the UPIM Work Model. Source: [1.TODO](1.TODO) lines 2-4.
...
- It is **not** a Foundry Platform module. Modules live in [../foundry-platform/](../foundry-platform/README.md).
- It is **not** the customer-facing GTM narrative. That kind of material — written for internal builders to internalize — lives in [../stakeholder-briefs/](../stakeholder-briefs/README.md).
