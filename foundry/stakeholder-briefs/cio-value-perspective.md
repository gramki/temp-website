...
- A **Workshop Project** corresponds to a **Product** in UPIM (the locus where the Product is evolved, not the Product entity itself).
- A Product has a **Home Workshop Project** — the canonical Workshop Project for that Product across Workshops — with a **Home Workshop** where it primarily lives.
- A Product may have **Contributing Workshop Projects** in Engagement Workshops that reference the Home Workshop Project and its non-work repositories.
